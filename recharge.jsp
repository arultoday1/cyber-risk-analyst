            ...
            <div class="col-sm-6">
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="tab1">
                        ...
                        <form action="Remobile" method="post">
                            <div class="form-group">
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="rsim" value="PREPAID" required="">PREPAID 
                                </label>
                            </div>&nbsp; &nbsp; &nbsp; &nbsp;
                            <div class="col-sm-4">
                                <label class="radio-inline">
                                    <input type="radio" name="rsim" value="PREPAID " required="">POSTPAID
                                </label>
                            </div>
                        </div>
                    </div>                              
...
<!-- Email account input-->
  ...
  <input type="text" name="memail" value="<%=email%>" placeholder="Email" class="form-control"  required="">  
  </div>
                            
                            
                            <div class="form-group">
                    <label class="col-form-label" for="MobileNumber">Mobile Number </label> 
                <input type="text" name="rmob" placeholder="Mobile Number" class="form-control" required="">    
                    </div> 
                          ...
                          <div class="form-group">
                                ...
                                <select class="form-control" name="rcircle" required="required" >
    ...
    <a href="mplans.jsp">Browse the Plans</a>
  </div>
    
    <div class="form-group">
     <input type="submit" value="PROCEED TO RECHARGE" class="btn btn-primary">
...
<!-- Email account input-->
  <div class="form-group">
  <label class="col-form-label" for="email">E-mail</label>  
  <input type="text" name="demail" value="<%=email%>" placeholder="Email" class="form-control"  required="">  
  </div>
    ...
    <label for="amount">Amount</label>
    <input type="text" name="amount" placeholder="Amount" class="form-control" required="">
    <a href="dplans.jsp">Browse the Plans</a>
  </div>
     ...
     <input type="submit" value="PROCEED TO RECHARGE" class="btn btn-primary">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab3">
                        ...
                        <br>
                           ...
                           <br>
                            <br>
                        <form action="Redatacard" method="post">
...
<!-- Email account input-->
  <div class="form-group">
  <label class="col-form-label" for="email">E-mail</label>  
  <input type="text" name="dcuemail" value="<%=email%>" placeholder="Email" class="form-control"  required="">  
  </div>

                            
                            <div class="form-group">
                                <label class="col-form-label" for="Datacard number">Enter your Datacard number </label> 
                             <input type="text" name="rdcard" placeholder="Datacard number" class="form-control" required="" >
                            </div>
                            
                         <div class="form-group">
                            <div class="agileits-select">
                                <label class="col-form-label">Service Provider</label>
                                <select class="form-control"  name="rdcname" required="" >
                                  <option data-tokens="Select Operator">Select Operator</option>
                                  <option data-tokens="Airtel">Airtel</option>                                  
                                  <option data-tokens="BSNL">BSNL</option>
                                  <option data-tokens="Tata Docomo">Tata Docomo</option>
    ...
    <label for="amount">Amount</label>
    <input type="text" name="amount" placeholder="Amount" class="form-control" required="">
    <a href="dcplans.jsp">Browse the Plans</a>
  </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab4">
                        ...
                        <br>                        
                            <span style="font-size: 130px" class="glyphicon glyphicon-phone-alt"></span>
                             ...
                             <br>
                            <br>
                        <form action="Blindline" method="post">
...
<!-- Email account input-->
  <div class="form-group">
  <label class="col-form-label" for="email">E-mail</label>  
  <input type="text" name="luemail" value="<%=email%>" placeholder="Email" class="form-control"  required="">  
  </div>
                            ...
                            <div class="agileits-select">
                                <select class="form-control"name="blandline" required="required" >
                                  <option data-tokens="Select Operator">Select Operator</option>
                            ...
                            <div class="form-group">
                             ...
                             <input type="text" name="blandnum" placeholder="Telephone Number(with STD code)" class="form-control" required="" >
                            </div>
                            
                           <div class="form-group">
    <label for="amount">Amount</label>
    <input type="text" name="amount" placeholder="Amount" class="form-control" required="">
    <a href="llpans.jsp">Browse the Plans</a>
  </div>
