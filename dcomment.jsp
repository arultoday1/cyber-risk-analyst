...
String serp=request.getParameter("ser");
System.out.println("Service Provider :"+serp);

String cd=request.getParameter("cuid");
...
<div class="container" style="margin-top: 70px">
    ...
    <div class="panel-body bg-info">
        <form action="Sdatacard" method="post">
            ...
            <div class="form-group">
            <label for="ser" class="col-form-label">Service Provider</label>
            <input type="text" name="ser" value="<%=serp%>" class="form-control" required="">
          </div>
            <div class="form-group">
            <label for="cid" class="col-form-label">Customer ID</label>
            <input type="text" name="cid" value="<%=cd %>" class="form-control" required="">
          </div>
